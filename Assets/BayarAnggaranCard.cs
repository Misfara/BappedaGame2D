...
public class BayarAnggaranCard : MonoBehaviour, ICard
{
    ...
    private void OnContinueButtonPressed()
    {
        ...
        if(effect == true){   
             ...
             KerjaCermat.kinerjaTotal = KerjaCermat.kinerjaTotal +1000;
            KerjaCermat.thisRoundAddedKinerja = KerjaCermat.thisRoundAddedKinerja +1000;
            targetTime.SubtractTime(0,50);
