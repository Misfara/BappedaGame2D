...
public class Asep: MonoBehaviour,IDataPersistence
{
    [Header("Visual Cue")]
    ...
    private int asepDialogueState = 1;
    ...
    public void OnButtonClicked()
    {
        ...
        if (playerInRange && !dialogueStarted && canInitiateDialogue)
        {
           ...
           player.canMove= false;
             ...
             if(asepDialogueState == 2){
             EnterDialogue(Dialogue2);
              dialogueStarted= true;
              player.canMove= false;
             }

              if(asepDialogueState == 3){
    ...
    {
        asepDialogueState++;
        if(asepDialogueState > maxDialogueState)
        {
            asepDialogueState = maxDialogueState;
        }
    ...
    {
        data.asepDialogueState = this.asepDialogueState;
          
    }

    public void LoadData(GameData data)
    {
        this.asepDialogueState = data.asepDialogueState;
