...
public class RekrutmenCard : MonoBehaviour, ICard
{
    ...
    private void OnContinueButtonPressed()
    {
        ...
        if(effect == true){   
             ...
             KerjaCermat.kinerjaTotal = KerjaCermat.kinerjaTotal +3000;
            KerjaCermat.thisRoundAddedKinerja = KerjaCermat.thisRoundAddedKinerja +3000;
