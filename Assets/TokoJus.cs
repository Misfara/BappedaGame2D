...
public class TokoJus: MonoBehaviour,IDataPersistence
{
    [Header("Visual Cue")]
    ...
    private int tokoJusDialogueState = 1;
    ...
    public void OnButtonClicked()
    {
        ...
        if (playerInRange && !dialogueStarted && canInitiateDialogue)
        {
           ...
           player.canMove= false;
             ...
             if(tokoJusDialogueState == 2){
             EnterDialogue(Dialogue2);
              dialogueStarted= true;
              player.canMove= false;
             }

              if(tokoJusDialogueState == 3){
    ...
    {
       tokoJusDialogueState++;
        if(tokoJusDialogueState > maxDialogueState)
        {
            tokoJusDialogueState= maxDialogueState;
        }
    ...
    {
        data.tokoJusDialogueState = this.tokoJusDialogueState;
          
    }

    public void LoadData(GameData data)
    {
        this.tokoJusDialogueState = data.tokoJusDialogueState;
