...
public class MrGreenDialogue : MonoBehaviour,IDataPersistence
{
    [Header("Visual Cue")]
    ...
    private int mrGreenDialogueState = 1;
    ...
    public void ExitingDialogue()
    {
        ...
        Debug.Log("dialogueState = " +  mrGreenDialogueState);
    }

    
    public void IncreasingDialogueState()
    {
        mrGreenDialogueState++;
        if(mrGreenDialogueState > maxDialogueState)
        {
           mrGreenDialogueState= maxDialogueState;
        }
    }

     public void SaveData(GameData data)
    {
        data.mrGreenDialogueState = this.mrGreenDialogueState;
    }

    public void LoadData(GameData data)
    {
        this.mrGreenDialogueState = data.mrGreenDialogueState;
    }
