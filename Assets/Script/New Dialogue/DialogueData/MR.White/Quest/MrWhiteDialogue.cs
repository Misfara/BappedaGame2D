...
public class MrWhiteDialogue : MonoBehaviour,IDataPersistence
{
    [Header("Visual Cue")]
    ...
    private int mrWhiteDialogueState = 1;
    ...
    public void ExitingDialogue()
    {
        ...
        Debug.Log("dialogueState = " +  mrWhiteDialogueState);
    }

    
    public void IncreasingDialogueState()
    {
        mrWhiteDialogueState++;
        if(mrWhiteDialogueState > maxDialogueState)
        {
            mrWhiteDialogueState = maxDialogueState;
        }
    }
    
     public void SaveData(GameData data)
    {
        data.mrWhiteDialogueState = this.mrWhiteDialogueState;
    }

    public void LoadData(GameData data)
    {
        this.mrWhiteDialogueState = data.mrWhiteDialogueState;
    }
      ...
      private void UpdateXPText()
{
    if (xpUI != null)
    {
        xpUI.text = "XP = " + player.playerXP.ToString();
    }
}
}