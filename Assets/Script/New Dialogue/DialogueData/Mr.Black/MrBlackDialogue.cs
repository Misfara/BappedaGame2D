...
public class MrBlackDialogue : MonoBehaviour,IDataPersistence
{
    [Header("Visual Cue")]
    ...
    private int mrBlackDialogueState = 1;
    ...
    public void OnButtonClicked()
    {
        ...
        if (playerInRange && !dialogueStarted && canInitiateDialogue)
        {
           ...
           player.canMove= false;
             ...
             if(mrBlackDialogueState == 2){
             EnterDialogue(Dialogue2);
              dialogueStarted= true;
              player.canMove= false;
             }

            if(mrBlackDialogueState == 3){
             EnterDialogue(Dialogue3);
              dialogueStarted= true;
              player.canMove= false;
             }

              if(mrBlackDialogueState == 4){
    ...
    public void ExitingDialogue()
    {
        ...
        Debug.Log("dialogueState = " +  mrBlackDialogueState);
    }

    
    public void IncreasingDialogueState()
    {
        mrBlackDialogueState++;
        if(mrBlackDialogueState > maxDialogueState)
        {
            mrBlackDialogueState = maxDialogueState;
        }
    }

    public void SaveData(GameData data)
    {
        data.mrBlackDialogueState = this.mrBlackDialogueState;
          
    }

    public void LoadData(GameData data)
    {
        this.mrBlackDialogueState = data.mrBlackDialogueState;
