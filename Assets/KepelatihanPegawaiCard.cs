...
public class KepelatihanPegawaiCard : MonoBehaviour, ICard 
{
    ...
    private void OnContinueButtonPressed()
    {
        ...
        if(effect == true){   
             ...
             KerjaCermat.kinerjaTotal = KerjaCermat.kinerjaTotal *1.3f;
            KerjaCermat.thisRoundAddedKinerja = KerjaCermat.thisRoundAddedKinerja *1.3f;
            targetTime.AddTime(0,60);
