...
public class Mechanic : MonoBehaviour,IDataPersistence
{
    [Header("Visual Cue")]
    ...
    private int MechanicDialogueState = 1;
    ...
    public void OnButtonClicked()
    {
        ...
        if (playerInRange && !dialogueStarted && canInitiateDialogue && energyToPlayMiniGame.currentEnergy >=1)
        {
           ...
           player.canMove= false;
             ...
             if(MechanicDialogueState  == 2){
             EnterDialogue(Dialogue2);
              dialogueStarted= true;
              player.canMove= false;
             }
             if(MechanicDialogueState  == 3){
             EnterDialogue(Dialogue3);
              dialogueStarted= true;
              player.canMove= false;
             }
             if(MechanicDialogueState  == 4){
    ...
    {
        MechanicDialogueState ++;
        if(MechanicDialogueState  > maxDialogueState)
        {
           MechanicDialogueState  = maxDialogueState;
        }
    }

    public void SaveData(GameData data)
    {
        data.mechanicDialogueState= this.MechanicDialogueState;
          
    }

    public void LoadData(GameData data)
    {
        this.MechanicDialogueState = data.mechanicDialogueState;
    ...
    public void OnQuestDone()
      {
        ...
        store.moneyCanGenerate = store.moneyCanGenerate + 175;
