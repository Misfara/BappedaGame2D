...
public class Fisherman: MonoBehaviour
{
    ...
    private int fishermanDialogueState = 1;
    ...
    public void ExitingDialogue()
    {
        ...
        Debug.Log("dialogueState = " +  fishermanDialogueState);
    }

    
    public void IncreasingDialogueState()
    {
        fishermanDialogueState++;
        if(fishermanDialogueState > maxDialogueState)
        {
           fishermanDialogueState= maxDialogueState;
        }
    }
