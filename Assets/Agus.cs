...
public class Agus : MonoBehaviour,IDataPersistence
{
    [Header("Visual Cue")]
    ...
    private int AgusDialogueState = 1;
    ...
    public void OnButtonClicked()
    {
        ...
        && energyToPlayMiniGame.currentEnergy >=1)
        {
           ...
           player.canMove= false;
             ...
             if(AgusDialogueState == 2){
             EnterDialogue(Dialogue2);
              dialogueStarted= true;
              player.canMove= false;
             }

            if(AgusDialogueState  == 3){
             EnterDialogue(Dialogue3);
              dialogueStarted= true;
              player.canMove= false;
             }

              if(AgusDialogueState  == 4){
    ...
    {
        AgusDialogueState ++;
        if(AgusDialogueState  > maxDialogueState)
        {
          AgusDialogueState = maxDialogueState;
        }
    }

    public void SaveData(GameData data)
    {
        data.AgusDialogueState = this.AgusDialogueState ;
          
    }

    public void LoadData(GameData data)
    {
        this.AgusDialogueState  = data.AgusDialogueState ;
    ...
    public void OnQuestDone()
      {
        ...
        store.moneyCanGenerate = store.moneyCanGenerate + 110;
