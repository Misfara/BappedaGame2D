...
public class Jajat: MonoBehaviour
{
    [Header("Visual Cue")]
    ...
    private int childDialogueState = 1;
    ...
    {
        childDialogueState++;
        if(childDialogueState > maxDialogueState)
        {
           childDialogueState= maxDialogueState;
        }
    }
