...
public class TahunAnggaranCard : MonoBehaviour, ICard
{
    ...
    private void OnContinueButtonPressed()
    {
        ...
        if(effect == true){   
             ...
             KerjaCermat.kinerjaTotal = KerjaCermat.kinerjaTotal +2000;
            KerjaCermat.thisRoundAddedKinerja = KerjaCermat.thisRoundAddedKinerja +2000;
            targetTime.AddTime(0,40);
