...
public class NPCSatgasData: MonoBehaviour
{
    [Header("Visual Cue")]
    ...
    private int satgasDataDialogueState = 1;
    ...
    {
       satgasDataDialogueState++;
        if(satgasDataDialogueState > maxDialogueState)
        {
          satgasDataDialogueState= maxDialogueState;
        }
    }
