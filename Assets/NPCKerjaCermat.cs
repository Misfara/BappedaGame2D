...
public class NPCKerjaCermat: MonoBehaviour
{
    [Header("Visual Cue")]
    ...
    private int kerjaCermatDialogueState = 1;
    ...
    {
       kerjaCermatDialogueState++;
        if(kerjaCermatDialogueState > maxDialogueState)
        {
          kerjaCermatDialogueState= maxDialogueState;
        }
    }
