...
public class MalayNeighbours: MonoBehaviour,IDataPersistence
{
    [Header("Visual Cue")]
    ...
    private int malayNeighboursDialogueState = 1;
    ...
    public void OnButtonClicked()
    {
        ...
        energyToPlayMiniGame.currentEnergy >= 1)
        {
             if ( malayNeighboursDialogueState == 1 ){
           EnterDialogue(dialogueObject);
           dialogueStarted= true;
           player.canMove= false;
             }
              if ( malayNeighboursDialogueState == 2 ){
           EnterDialogue(Dialogue2);
           dialogueStarted= true;
           player.canMove= false;
             }
             if ( malayNeighboursDialogueState == 3 ){
           EnterDialogue(Dialogue3);
           dialogueStarted= true;
           player.canMove= false;
             }

            if ( malayNeighboursDialogueState == 4 ){
    ...
    {
        malayNeighboursDialogueState++;
        if(malayNeighboursDialogueState > maxDialogueState)
        {
           malayNeighboursDialogueState= maxDialogueState;
        }
    }
     ...
     public void OnQuestDone()
      {
        ...
        store.moneyCanGenerate = store.moneyCanGenerate + 150;
...
{
    data.malayNeighbourDialogueState = this. malayNeighboursDialogueState;
}

public void LoadData (GameData data)
{
    this.malayNeighboursDialogueState = data.malayNeighbourDialogueState;
}
