...
public class Mechanic2 : MonoBehaviour,IDataPersistence
{
    [Header("Visual Cue")]
    ...
    private int Mechanic2DialogueState = 1;
    ...
    {
        Mechanic2DialogueState ++;
        if(Mechanic2DialogueState > maxDialogueState)
        {
           Mechanic2DialogueState  = maxDialogueState;
        }
    }

    public void SaveData(GameData data)
    {
        data.Mechanic2DialogueState= this.Mechanic2DialogueState;
          
    }

    public void LoadData(GameData data)
    {
        this.Mechanic2DialogueState = data.Mechanic2DialogueState;
